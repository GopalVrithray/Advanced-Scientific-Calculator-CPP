...
//The main function contains a loop that repeatedly displays a menu and performs operations based on user input
int main()
{
	char x;
	do
		...
		switch(a)
		{
			case(1): //Basic Mathematical Operations
			...
			case(4): //Unit Conversions
				...
				case(5): //Additional Functions
					...
					break;
					case(6): //Innovatively Designed Functions
					cout<<"Please select the function\n";
